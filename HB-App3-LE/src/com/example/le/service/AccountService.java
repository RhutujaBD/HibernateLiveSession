...
public class AccountService {
	...
	public static void main(String[] args) {
		...
		/*
		 * try { //org.hibernate.ObjectNotFoundException: AccountBean accountBeanLoad =
		 * // (AccountBean) session.load(AccountBean.class, 5L);
		 * 
		 * java.lang.NullPointerException: Cannot invoke
		 * "com.example.le.bean.AccountBean.getAccNo()" AccountBean accountBeanLoad
		 * =(AccountBean) session.get(AccountBean.class, 3L);
		 * System.out.println("Account Details .. : ");
		 ...
		 * accountBeanLoad.getAccCreationDate());
		 * 
